class  Inventory::Sale < ActiveRecord::Base
  ...
  belongs_to :dailysale
    ...
    validates_presence_of       :amount,:amount_cost, message: I18n.t('models.inventory.sale.messages.presence_amount')
    ...
    validates_numericality_of   :amount, :amount_cost, :quantity, message: I18n.t('models.inventory.sale.messages.alone_numbers')
